...
class LeverancierController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
            'bedrijfsnaam' => 'required|unique:leveranciers,bedrijfsnaam,' . $leverancier->id . '|max:255',
        ...
        $leverancier->telefoonnummer = $validatedData['telefoonnummer'];
        // Update de rest van de velden
